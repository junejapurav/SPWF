        ...
        <footer> 
            <div className="upperFooter">
                ...
                <div className="tags-footer">
                    ...
                    <Link to={'/gallery'}><p className="footerp">Gallery</p></Link>
